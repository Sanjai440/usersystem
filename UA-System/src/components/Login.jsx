...
//         // 🔥 IMPORTANT FIX (ADD ID)
//         const userData = {
//           id: result.user.id,              // ✅ FIXED
//           name: result.user.name || username,
//           email: result.user.email || `${username}@mail.com`,
//           role: "user",
//         };
      ...
      if (result.status === "success") {
        ...
        const userData = {
          ...
          role: "user",
            ...
            // email: result.email || result.username + "@gmail.com", // ✅ ONLY ADD THIS
